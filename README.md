...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH39&template=betrybe/sd-0x-project-trybetunes-vite-ts)
...
- <details><summary> Ao clicar no botão de <code>Pesquisar</code>, limpe o valor do input e faça uma requisição utilizando a função do arquivo <code>services/searchAlbumsAPIs.ts</code>:</summary>
  ...
  - Liste os álbuns retornados:
    ...
    - Exiba o nome do album em cada item da lista. O `nome do album` é o valor da propriedade `collectionName` retornada pela API.
